...
class FFmpegTranscoder:
    ...
    Uses subprocess.run() for maximum Windows compatibility.
    """
    ...
    async def transcode(
        ...
        if target_format == "mp3":
            ...
            selected_bitrate = bitrate_map.get(
                audio_quality,
                "320k"
            )
            ...
            command = [
                r"E:\ffmpeg-8.1.1-essentials_build\ffmpeg-8.1.1-essentials_build\bin\ffmpeg.exe",
                "-y",
                "-i",
                str(input_file),
                "-vn",
